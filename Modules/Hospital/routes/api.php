...
Route::prefix('/hospital/select')->middleware([HeaderAuthenticationMiddleware::class,'auth:api'])->group(function() {
    ...
    Route::get('/referred-hospital', [HospitalController::class,'referredHospital'])->name('referred_hospital');
...
Route::prefix('/hospital')->middleware([HeaderAuthenticationMiddleware::class,'auth:api'])->group(function() {
    ...
    Route::post('/ipdprescription/create-generic-medicine/{id}', [IpdPrescriptionController::class,'createGenericMedicine'])->name('createGenericMedicine');
    ...
    Route::prefix('lab-investigation')->name('lab-investigation.')->group(function () {
        ...
        Route::get('free-investigation', [LabInvestigationController::class, 'freeInvestigation'])->name('freeInvestigation');
        Route::post('free-investigation-create/{id}', [LabInvestigationController::class, 'freeInvestigationCreate'])->name('freeInvestigationCreate');
    ...
    Route::prefix('billing')->name('billing')->group(function () {
        ...
        Route::get('{id}/final-bill-process', [BillingController::class, 'finalBillProcess'])->name('find_bill');
    ...
    Route::prefix('reports')->middleware([HeaderAuthenticationMiddleware::class])->group(function() {
        ...
        Route::get('/discharge-patient', [ReportsController::class,'dischargePatient'])->name('report_patient_ticket');

...
class HospitalSalesModel extends Model
{
    ...
    public static function getPatientMedicineIssueDetails($params, $domain)
    {
    ...
    public static function getMedicineIssueDetails($params, $domain)
    {
        ...
        $query = InvoiceModel::whereHas('prescriptions', function ($q) use ($warehouseId, $startDate, $endDate) {
